            ...
            <div className="premium-card rounded-xl border bg-card p-8 shadow-lg">
                <div className="mb-6 text-center">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                        Создайте аккаунт для своего бизнеса
                    </p>
                </div>
                ...
                {success ? (
                    <div className="space-y-4">
                        ...
                        <Link
                            ...
                            className="block w-full text-center px-4 py-2 border border-gray-300 rounded-lg text-sm hover:bg-gray-50"
                        >
                        ...
                        <Link
                            href="/"
                            className="block w-full text-center px-4 py-2 bg-primary text-primary-foreground rounded-lg text-sm hover:opacity-90"
                        >
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <input
                                        ...
                                        placeholder="salon"
                                        required
                                        className="flex-1 rounded-md border bg-background px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary"
                                    />
                                </div>
